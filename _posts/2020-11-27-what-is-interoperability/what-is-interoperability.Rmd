...
<aside>
Addition, April 2023: As it goes, the link to the definition of \"interoperability\" does not work anymore. The version that is save on the webarchive also has a problem in whatever system used there... so much for interoperability, right!?
</aside>
